...
fun LineTo.bindXY(point: ReadOnlyPoint2DProperty) =
    ReadOnlyPoint2DProperty.bindToPoint(this.xProperty(), this.yProperty(), point)

fun LineTo.unbind() = ReadOnlyPoint2DProperty.unbindPoint(this.xProperty(), this.yProperty())
fun ArcTo.bindXY(point: ReadOnlyPoint2DProperty) =
    ReadOnlyPoint2DProperty.bindToPoint(this.xProperty(), this.yProperty(), point)

fun ArcTo.unbind() = ReadOnlyPoint2DProperty.unbindPoint(this.xProperty(), this.yProperty())
fun MoveTo.bindXY(point: ReadOnlyPoint2DProperty) =
    ReadOnlyPoint2DProperty.bindToPoint(this.xProperty(), this.yProperty(), point)
