...
fun main() {
    ...
    val v1 = PVertex(Player.ONE, "1", 4 - 1)
    val v2 = PVertex(Player.ONE, "2", 4 - 2)
    val v3 = PVertex(Player.ONE, "3", 4 - 3)
    val v4 = PVertex(Player.TWO, "4", 4 - 4)
    v1.addEdgeTo(v1, v2)
    v2.addEdgeTo(v2, v3)
    v3.addEdgeTo(v3, v4)
    v4.addEdgeTo(v4, v1)
